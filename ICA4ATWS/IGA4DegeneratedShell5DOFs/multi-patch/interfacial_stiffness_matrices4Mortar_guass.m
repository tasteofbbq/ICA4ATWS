...
function [interfacial_stiffness] = interfacial_stiffness_matrices4Mortar_guass(Skin_total, temp_information,temp_coupling_points,alpha)
...
switch_value         = temp_information(3,2);
...
if(patch_index1<=patch_index2)
    switch switch_value
        ...
        case 1
            Ks = [Ks_upper_left -Ks_upper_right];
    end
else
    switch switch_value
        case 0
        ...
        case 1
            Ks = [-Ks_upper_right Ks_upper_left];
    end
end
