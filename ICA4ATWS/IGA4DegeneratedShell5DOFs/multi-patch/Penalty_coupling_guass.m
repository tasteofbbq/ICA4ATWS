...
function [multi_K,multi_K_b] = Penalty_coupling_guass(Total_Skin, information, coupling_points, alpha)
if(length(alpha)==1)
...
if(~isempty(information))
    for i = 1:length(information)
        ...
        switch self_tie
            case 0
                [interfacial_stiffness] = interfacial_stiffness_matrices4Penalty_guass(Skin, temp_information,temp_coupling_points,alpha(i));
            case 1
                continue;
            case 2
                [interfacial_stiffness] = interfacial_stiffness_matrices4Penalty_guass(Skin, temp_information,temp_coupling_points,alpha(i));
        ...
        fprintf('No.%d coupling(Penalty) has been done!\n', i)
    end
end
